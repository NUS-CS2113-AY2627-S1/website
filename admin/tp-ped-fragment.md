...
1. Open a command window. Run the `java -version` command to ensure you are using Java 25.<br>
...
1. **Check the UG** of the team to see if there are extra things you need to do before launching the JAR.<br>
   **Confirm that you are using Java 25** and using the `java -jar` command to run the JAR, as explained in the points above.
